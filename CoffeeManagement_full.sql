...
('Nước ngọt', 'Hoạt động', 'Bánh ngọt và snack', 0),
...
('Sinh tố xoài', 'Hoạt động', 'Sinh tố trái cây', 30000, 3,'sinhtoxoai.png'),
('Pepsi lon', 'Hoạt động', 'Nước giải khát', 20000, 5, 'pepsilon.png'),
('Bánh su kem', 'Hoạt động', 'Bánh ngọt mini', 15000, 4, 'banhsukem.png'),
('Trà đào cam sả', 'Hoạt động', 'Trà trái cây', 35000, 2, 'tradaocamsa.png');
