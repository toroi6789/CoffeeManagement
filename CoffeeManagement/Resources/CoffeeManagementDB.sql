...
-- 6. Sản phẩm
INSERT INTO SanPham (TenSanPham, TrangThai, MoTa, GiaBan, DanhMucID) VALUES
('Cà phê sữa đá', 'Hoạt động', 'Cà phê pha phin', 25000, 1),
('Trà đào cam sả', 'Hoạt động', 'Trà trái cây', 35000, 2),
('Sinh tố xoài', 'Hoạt động', 'Sinh tố tươi', 30000, 3),
('Bánh su kem', 'Hoạt động', 'Bánh mini', 15000, 4),
('Cà phê đen đá', 'Hoạt động', 'Cà phê phin', 20000, 1);
